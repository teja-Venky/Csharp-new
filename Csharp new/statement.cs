...
//        // own code: different simple example showing declaration, assignment, constants, array, loop, and expression statements — but using temperature conversion instead of radius.
...
//            double[] celsiusValues = { 0, 25, 37, 100 };
...
//                Console.WriteLine($"Temperature #{count}: {celsius}°C = {fahrenheit:F2}°F");
