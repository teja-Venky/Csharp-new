...
//{
//    internal class Pattern_Matching
//    {
//        static void Main(string[] args)
//        {

//            //program 1: match a value (patteren matching) using a switch expression.
//            string bankRecords = """
...
//                    if (transactionType?.ToUpper() is "DEPOSIT")       //you can match the record against a pattern by using either an is or switch expression. 
...
//            //program3: Exhaustive matches with switch
//            int n = GetNumber();
